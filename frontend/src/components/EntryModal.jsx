...
export default function EntryModal({
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-sm flex items-center justify-center">
      {/* Modal container */}
      <div className="bg-surface border border-border-strong rounded-xl p-6 w-175 py shadow-[0_34px_70px_-18px_rgba(0,0,0,0.78)]">
        ...
        <div className="py-3 border-b border-border">
          <label className="text-text-muted text-xs uppercase tracking-wide">Note</label>
          <textarea
        ...
        {selectedStatus === 'Done' && (
          <div className="py-3">
            <label className="text-text-muted text-xs uppercase tracking-wide">Rating</label>
            <div
